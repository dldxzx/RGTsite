...
if __name__ == '__main__':
    ...
    val_dataset = SMILES_Protein_Dataset(root=val_root,raw_dataset='nw30_val.csv',processed_data='nw30_val.pt')
    test_dataset = SMILES_Protein_Dataset(root=test_root,raw_dataset='nw30_test.csv',processed_data='nw30_test.pt')
    # 打开文件，以追加方式写入
    for epoch in range(epochs):
        ...
        with open(f"RGTsite/results/nw30.txt", 'a') as f:
            ...
            f.write('Test:  Sen: {:.4f}, Spe: {:.4f}, Acc: {:.4f}, Pre: {:.4f}, F1: {:.4f}, MCC: {:.4f}, AUC: {:.4f}\n'
                    .format(Sen, Spe, Acc, Pre, F1, MCC, auc))
            model_path = f'RGTsite/results/nw30/'
            # 检查目录是否存在
