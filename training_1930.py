...
if __name__ == '__main__':
    ...
    val_dataset = SMILES_Protein_Dataset(root=val_root,raw_dataset='val_1930.csv',processed_data='val_1930.pt')
    ...
    for epoch in range(epochs):
        ...
        with open(f"RGTsite/results/1930.txt", 'a') as f:
            ...
            f.write('Test:  Sen: {:.4f}, Spe: {:.4f}, Acc: {:.4f}, Pre: {:.4f}, F1: {:.4f}, MCC: {:.4f}, AUC: {:.4f}\n'
                    .format(Sen, Spe, Acc, Pre, F1, MCC, auc))
            model_path = f'RGTsite/results/1930/'
            # 检查目录是否存在
